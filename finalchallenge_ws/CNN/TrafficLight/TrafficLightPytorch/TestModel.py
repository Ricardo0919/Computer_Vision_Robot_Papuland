...
# ------------------------------------------------------------------------------
# Descripción:
# Este script carga el modelo reentrenado con data augmentation y realiza
# inferencias en tiempo real usando la cámara principal del equipo.
# ------------------------------------------------------------------------------

# Cargar el modelo reentrenado (ajusta la ruta si lo moviste)
model = YOLO('runs/detect/traffic_light_finetuned_aug/weights/best.pt')
...
cv2.namedWindow("YOLOv8 - Reentrenado", cv2.WINDOW_NORMAL)
