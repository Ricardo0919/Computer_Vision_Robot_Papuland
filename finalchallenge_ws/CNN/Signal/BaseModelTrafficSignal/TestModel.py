# ------------------------------------------------------------------------------
# Proyecto: Puzzlebot Final Challenge - Prueba en tiempo real del modelo YOLOv8 con cámara
...
# Cargar el modelo reentrenado (ajusta la ruta si lo moviste)
model = YOLO('runs/detect/traffic_signals_base_model/weights/best.pt')
...
cv2.namedWindow("YOLOv8 - Detección de señales", cv2.WINDOW_NORMAL)
...
while True:
    ...
    try:
        ...
        results = model(resized_frame, imgsz=160, conf=0.65)
